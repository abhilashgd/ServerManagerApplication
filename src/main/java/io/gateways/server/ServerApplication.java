...
public class ServerApplication {
	...
	//below code is common for every application
	//without this code, if front end tries to communicate with backend end then we get an error
	...
	public CorsFilter corsFilter(){
		...
		corsConfiguration.setAllowedOrigins(Arrays.asList("Origin", "Access-Control-Allow-Origin",
				"Content-Type","Accept", "Jwt-Token","Authorization", "Origin, Accept",
				"X-Requested-With","Access-Control-Request-Method", "Access-Control-Request-Headers"));
		corsConfiguration.setExposedHeaders(Arrays.asList("Origin", "Content-Type","Accept", "Jwt-Token",
				"Authorization","Access-Control-Allow-Origin","Authorization","Access-Control-Allow-Origin",
				"Authorization","Access-Control-Allow-Credentials","Filename"));
